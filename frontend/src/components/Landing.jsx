                    ...
                    <header className="max-w-[1170px] mx-auto ">
                        <div className="grid sm:grid-cols-2 grid-cols-[30%_auto] px-[10px] items-center">
                            ...
                            <div className="flex justify-end gap-[20px]">
                                ...
                                <button onClick={handlesignin} className="font-poppins font-bold bg-red-600 hover:bg-red-700 transition duration-300 ease-in-out rounded-[5px] text-white px-[15px]">
                                    Sign In
                                </button>
                            </div>
                        </div>
